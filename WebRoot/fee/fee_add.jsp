...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <!--主要区域开始-->
        <div id="main">            
            <div id="save_result_info" class="save_fail">保存失败，资费信息填写出错！</div>
...
//资费名称输入框失去焦点
	$('#feeName').blur(function(){
		...
		if(feeName==''){
			...
			$.post("../validName/feeNameValidName",{"fee.name":feeName},function(data){
				if(data=='false'){
					$('#nameLabel').addClass("error_msg").html("资费名称重复");
				}else{
